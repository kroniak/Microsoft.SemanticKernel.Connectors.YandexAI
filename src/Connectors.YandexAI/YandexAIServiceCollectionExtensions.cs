...
public static class YandexAIServiceCollectionExtensions
{
    ...
    /// </summary>
    /// <param name="services">The <see cref="IKernelBuilder" /> instance to augment.</param>
    ...
    public static IServiceCollection AddYandexAIChatCompletion(
